...
/**
 * Class with the implementation to connect and access to MySql Database
 * @author tebi
 *
 */
/*
...
require_once 'php/Database/Core/DatabaseIf.php';
class MySqlDatabase implements DatabaseIf {
    ...
    * Constructor
    *
    * @param $theConnectionData. Array
    *           with the connection data to can
    ...
    * @param string $thePwd           
    */
   /*function __construct($theHost, $theDDBB, $theUser, $thePwd){
   ...
   public function connect($autoCommit = true) {
      if (! $this->isConnectedM) {
         ...
         $this->connectionM->set_charset("utf8");
      }
      return true;
   }
