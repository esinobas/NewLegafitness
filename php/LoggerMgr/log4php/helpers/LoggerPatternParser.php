...
class LoggerPatternParser {
   ...
   public function __construct($pattern, $converterMap) {
      ...
      $this->regex = '/' . // Starting regex pattern delimiter
...
'/'; // Ending regex pattern delimiter
    ...
    *
    * @param string $string
    *           The string for the literal converter.
    */
    ...
    *
    * @param string $word
    *           The conversion word, used to determine which
    *           converter will be used.
    * @param string $modifiers
    *           Formatting modifiers.
    * @param string $option
    *           Option to pass to the converter.
    */
    ...
    * @param string $word
    *           The conversion word.
    * @param LoggerFormattingInfo $info
    *           Formatting info.
    * @param string $option
    *           Converter option.
    *           
