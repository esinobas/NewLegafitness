...
class Logger {
   ...
   /**
    * Logger additivity.
    * If set to true then child loggers will inherit
   ...
   /**
    * The parent logger.
    * Set to null if this is the root logger.
    */
   private $parent;
    ...
    * Can be null if this is the root logger.
    * 
    * @return Logger
    */
    ...
    *           Optional throwable information to include
    ...
    *           an appender name or a {@link LoggerAppender} instance.
    */
    ...
    *
    * @param LoggerLevel $level
    *           The level to set, or NULL to clear the logger level.
    */
    ...
    *           Either a path to the configuration
    *           file, or a configuration array.
    *           
    * @param string|LoggerConfigurator $configurator
    *           A custom
    ...
    * configurator class.
    * If no class is given, returns an instance of
