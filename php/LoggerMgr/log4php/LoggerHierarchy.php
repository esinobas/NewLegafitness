 ...
 * The logger hierarchy is dealing with the several Log-Levels
...
class LoggerHierarchy {
   ...
   /**
    * Main level threshold.
    * Events with lower level will not be logged by any
   ...
   /**
    * Prints the current Logger hierarchy tree.
