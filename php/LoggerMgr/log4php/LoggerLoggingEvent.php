...
class LoggerLoggingEvent {
    ...
    * to do it again.
    * Note that its value is always false when
    ...
    * At present renderedMessage == message.
    * 
    * @var string
    */
    ...
    * @param mixed $logger
    *           The {@link Logger} category of this event or the logger name.
    ...
    *           The throwable associated with logging event
    */
    ...
    * Use this form instead of directly
